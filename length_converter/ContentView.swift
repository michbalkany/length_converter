...
//  length_converter
//
//  Created by Mich balkany on 9/13/23.
//
...
// conversion math inside a computed property. first by converting everything into meters and then meters to everything else
    var result: String {
...
// add the keyboard toolbar so user may exit the keyboard
            .toolbar {
